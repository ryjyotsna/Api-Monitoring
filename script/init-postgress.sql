...
CREATE INDEX IF NOT EXISTS idx_endpoint_metrics_client_time ON endpoint_metrics (client_id);
...
CREATE INDEX IF NOT EXISTS idx_endpoint_metrics_error_hits ON endpoint_metrics (client_id, service_name, endpoint);
